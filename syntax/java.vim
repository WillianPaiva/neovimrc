...
syn keyword javaFunc	        extends implements interface
syn keyword javaTypeDec	        extends implements interface
...
syn match   javaFunc            "[a-zA-Z0-9|-|_]*\((\)\@="
"syn match   javaTypeDec         "\(<\)\@<=[a-zA-Z0-9]*\(>\)\@="
...
syn cluster javaTop add=javaString,javaCharacter,javaNumber,javaSpecial,javaStringError,JavaDocComment
...
if version >= 508 || !exists("did_java_syn_inits")
  ...
  JavaHiLink javaDocComment		Special
